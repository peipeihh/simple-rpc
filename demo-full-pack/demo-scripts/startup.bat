echo "start the service consumer."
...
::java -Dserver.port=9000 -Drpc.client.lb=roundrobin -Drpc.client.ha=failfast -Drpc.client.remote.service=http://localhost:9090/rpc,http://localhost:9091/rpc,,http://localhost:9092/rpc -jar %service_consumer_jar%

::echo "start the service provider."
